defmodule AlchemyBookWeb.Router do
  use AlchemyBookWeb, :router
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: AlchemyBookWeb.Telemetry
    end
  end
end
